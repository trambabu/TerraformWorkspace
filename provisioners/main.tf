...
resource "aws_instance" "server" {
  ...
  connection {
    ...
    private_key = file("~/.ssh/trambabu_git_rsa_key")             # Path to private key
    host        = self.public_ip
    timeout     = "2m"
  }
  ...
  provisioner "file" {
    source      = "file10.txt"
    destination = "/home/ubuntu/file10.txt"
  }
...
#       user        = "ubuntu"
#       private_key = file("~/.ssh/trambabu_git_rsa_key")
#     }

#     inline = [
#       "echo 'hello from awsdevopsmulticloud-by-trambabu' >> /home/ubuntu/file200"
#     ]
#   }
